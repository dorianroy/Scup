package com.dasflash.soundcloud.scup.model
{
	...
	public class SetData extends EventDispatcher
	{
		...
		// license 	
		public var licenseTypes:ArrayCollection = new ArrayCollection(
			[
		...
		{
			return licenseTypes.getItemAt(selectedLicenseIndex).data;
		}
		public function set license(value:String):void
		{
			for (var i:int=0; i<licenseTypes.length; i++) {
				if (licenseTypes.getItemAt(i).data == value) {
